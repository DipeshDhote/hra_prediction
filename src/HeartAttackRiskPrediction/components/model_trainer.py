...
class ModelTrainer:
    ...
    def initate_model_training(self,train_array,test_array):
        try:
            ...
            print(f'Best Model Found , Model Name : {best_model_name} , Accuracy Report : {best_model_score}')
            print('\n====================================================================================\n')
            logging.info(f'Best Model Found , Model Name : {best_model_name} , Accuracy Report : {best_model_score}')
